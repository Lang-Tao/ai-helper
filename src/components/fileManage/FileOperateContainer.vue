  ...
  <div>
    <div class="file-operate-container">
      <div @contextmenu.prevent="showMenu($event)" class="right-container" @dragover.prevent @drop="handleDrop">
        <div class="nav-right">
          ...
          <div class="search">
            <el-input size="mini" placeholder="请输入文件名称" v-model="keyword">
        ...
        <div class="file-list-container">
          <div
            ...
            <div
              ...
              <i :class="item.fileType === 'path' ? 'el-icon-folder' : 'el-icon-document'"/>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="closePreview">关 闭</el-button>
      </span>
    </el-dialog>
    ...
    >
      <el-input size="mini" v-model="inputFolderName" placeholder="请输入文件夹名称"/>
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="cancelCreateFolder">取 消</el-button>
        <el-button size="mini" type="primary" @click="confirmCreateFolder">确 定</el-button>
      </span>
    </el-dialog>
    ...
    <el-dialog
        ...
        @cancel="cancelRename"
    >
      <el-input size="mini" v-model="inputPathName" placeholder="请输入新名称"/>
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="cancelRename">取 消</el-button>
      ...
      <div class="progress-container">
        ...
        <div class="progress-number">
          <div style="float: right">
            ...
            <i v-else class="el-icon-circle-check" style="color: #52c41a"/>
          </div>
        </div>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    onSelect(data) {
      this.currentPath = data.filePath
      this.listFilesByPath(this.currentPath)
    },
    dragStart(event) {
